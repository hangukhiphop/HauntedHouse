...
namespace itp380
{
	...
	public class InputManager : itp380.Patterns.Singleton<InputManager>
	{
		...
		private void InitializeBindings()
		{
			...
			// UI Bindings
			m_Bindings.Add(eBindings.UI_Exit, new BindInfo(Keys.P, eBindType.JustPressed));
			// TODO: Add any additional bindings here
            m_Bindings.Add(eBindings.Boo_Left, new BindInfo(Keys.A, eBindType.Held));
            m_Bindings.Add(eBindings.Boo_Right, new BindInfo(Keys.D, eBindType.Held));
            m_Bindings.Add(eBindings.Boo_Forward, new BindInfo(Keys.W, eBindType.Held));
            m_Bindings.Add(eBindings.Boo_Backward, new BindInfo(Keys.S, eBindType.Held));

            m_Bindings.Add(eBindings.Boo_Jumped, new BindInfo(Keys.Space, eBindType.JustPressed));
            m_Bindings.Add(eBindings.Reload_XML, new BindInfo(Keys.Z, eBindType.JustPressed));
            m_Bindings.Add(eBindings.Boo_Jump, new BindInfo(Keys.Space, eBindType.Held));
            m_Bindings.Add(eBindings.Boo_Letgo, new BindInfo(Keys.Space, eBindType.JustReleased));
